...
INSERT INTO ville (ville, code_postal, departement, region) VALUES 
...
INSERT INTO utilisateur (nom, prenom, email, mdp, adresse, tel, date_naissance, id_role) VALUES 
('Lemoine', 'Pierre', 'pierre.lemoine@email.com', 'pierre2024', '3 rue de la Paix, 35000 Rennes', '0701234567', '1992-01-20', 2),
('Roux', 'Marie', 'marie.roux@email.com', 'mariepass456', '45 avenue Jean Jaurès, 38000 Grenoble', '0712345678', '1987-05-14', 5),
('Fournier', 'Hugo', 'hugo.fournier@email.com', 'hugo.789pass', '12 rue de la Liberté, 21000 Dijon', '0723456789', '1980-11-30', 1),
('Andre', 'Léa', 'lea.andre@email.com', 'lea2024pass', '28 rue du Commerce, 42000 Saint-Étienne', '0734567890', '1996-08-17', 6),
('Mercier', 'Paul', 'paul.mercier@email.com', 'paulpass321', '5 quai de la Seine, 76600 Le Havre', '0745678901', '1991-03-25', 2),
('Dupont', 'Jean', 'jean.dupont@email.com', 'password123', '10 rue de Paris, 75001 Paris', '0612345678', '1985-03-15', 2),
('Martin', 'Sophie', 'sophie.martin@email.com', 'securepass456', '25 avenue des Fleurs, 13001 Marseille', '0623456789', '1990-07-22', 2),
('Bernard', 'Lucas', 'lucas.bernard@email.com', 'admin789', '5 place Bellecour, 69001 Lyon', '0634567890', '1978-11-10', 1),
('Petit', 'Emma', 'emma.petit@email.com', 'userpass321', '15 rue du Taur, 31000 Toulouse', '0645678901', '1995-02-28', 2),
('Robert', 'Thomas', 'thomas.robert@email.com', 'modpass654', '8 boulevard Gambetta, 06000 Nice', '0656789012', '1988-09-05', 3),
('Richard', 'Julie', 'julie.richard@email.com', 'guestpass987', '42 rue Crébillon, 44000 Nantes', '0667890123', '2000-12-18', 4),
('Dubois', 'Nicolas', 'nicolas.dubois@email.com', 'pass123456', '7 rue de la Nuée Bleue, 67000 Strasbourg', '0678901234', '1982-06-30', 2),
('Moreau', 'Clara', 'clara.moreau@email.com', 'secure987654', '12 rue de la Loge, 34000 Montpellier', '0689012345', '1993-04-12', 2),
...
(5, 5, '3 boulevard Wilson, 06000 Nice', 'Graffitis sur mur public', 'Des graffitis ont été tagués sur le mur de l''école primaire Jean Jaurès.', 'Basse', 12, 'graffiti_nice.jpg'),
(7, 7, '8 place Kléber, 67000 Strasbourg', 'Banc public cassé', 'Un banc public place Kléber est cassé avec des lattes manquantes. Danger pour les personnes âgées.', 'Moyenne', 34, NULL),
(10, 8, '50 rue de la Monnaie, 59000 Lille', 'Fuite d''eau sur voie publique', 'Une fuite d''eau importante est visible au niveau du 50 rue de la Monnaie. Gaspillage d''eau important.', 'Haute', 91, 'fuite_lille.jpg'),
(2, 11, '10 avenue du Prado, 13001 Marseille', 'Arbre menaçant de tomber', 'Suite aux vents violents, un arbre est penché dangereusement au-dessus de la voie publique.', 'Urgente', 156, 'arbre_danger_marseille.jpg'),
...
(5, 4, 500, 'Nettoyage graffitis école Jean Jaurès', '2024-02-10', '2024-02-11', '2024-02-12'),
(10, 6, 2500, 'Réparation fuite d''eau rue de la Monnaie', '2024-03-05', '2024-03-05', '2024-03-08'),
(2, 7, 4200, 'Abattage et évacuation arbre dangereux avenue du Prado', '2024-04-01', '2024-04-01', '2024-04-03');

-- Insertion de messages
INSERT INTO message (content, objet) VALUES 
('Vos travaux de réparation du nid-de-poule rue de Rivoli ont été planifiés pour le 20 janvier.', 'Confirmation de travaux'),
('Merci pour votre signalement. Un technicien va intervenir dans les 48h.', 'Signalement pris en compte'),
('Rappel : maintenance des espaces verts prévue ce vendredi dans votre quartier.', 'Information maintenance'),
...
INSERT INTO gerant (id_utilisateur, id_ville) VALUES 
(3, 1),
(9, 2),
(13, 3),
(4, 4),
